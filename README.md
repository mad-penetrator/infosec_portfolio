...
## Итоги
- Освоены команды для мониторинга процессов (`ps`, `top`, `pstree`).
- Изучена работа systemd и структура unit-файлов.
- Сформированы базовые признаки подозрительных сервисов для дальнейшего анализа при расследованиях.
